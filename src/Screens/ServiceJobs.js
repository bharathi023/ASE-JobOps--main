...
export default function Gigs() {
  ...
  return (
    ...
    {job?(
        ...
        return(
            data.role.toLowerCase() === job.toLowerCase() || data.companyname.toLowerCase() === job.toLowerCase() || data.location.toLowerCase() === job.toLowerCase()  && data.Jobtype.toLowerCase()=== "Servicejobs"?(
