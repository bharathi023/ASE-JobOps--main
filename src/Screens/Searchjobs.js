...
export default function Searchjobs() {
  ...
  return (
    ...
    {job?(
        ...
        return(
            data.role.toLowerCase() == job.toLowerCase() || data.companyname.toLowerCase() == job.toLowerCase() || data.location.toLowerCase() == job.toLowerCase() ?(
    ...
    <div style={{display:"block",gap:"20px"}}> 
        ...
        <div>
            <h2 className='button'style={{cursor:"pointer"}} >View</h2>
        </div>
