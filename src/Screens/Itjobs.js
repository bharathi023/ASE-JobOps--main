...
export default function Gigs() {
  ...
  return (
    ...
    {job?(
        ...
        return(
            data.role.toLowerCase() === job.toLowerCase() || data.companyname.toLowerCase() === job.toLowerCase() || data.location.toLowerCase() === job.toLowerCase()  && data.Jobtype === "itindustry"?(
    ...
    <div style={{display:"block",gap:"20px"}}> 
        ...
        <div style={{display:"flex",gap:"5px",border:"1px solid #EEEEEE",borderRadius:"5px"}}>
            ...
            <h2 style={{color:"black"}}>{data.Jobtype}</h2>
        </div>
